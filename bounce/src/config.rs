...
pub const FONT_KARMATIC: &str  = "fronts/karmatic.ttf";
pub const FONT_BOXY: &str = "fonts/Boxy-Bold.ttf";
pub const FONT_ALAGARD: &str = "fonts/Alagard.ttf";
pub const FONT_INVASION: &str = "fronts/Invasion2000.ttf";
